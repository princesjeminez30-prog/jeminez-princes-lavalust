    ...
    <div class="w-full max-w-lg bg-white rounded-xl shadow-lg border border-slate-100 p-8">
        ...
        <div class="flex items-center justify-between border-b border-slate-100 pb-5 mb-6">
            <div>
                ...
                <p class="text-sm text-slate-500">Create a new item entry in your system</p>
            </div>
        ...
        <form action="/products/store" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3" placeholder="Add product details..."
                    class="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white text-sm text-slate-800"></textarea>
            </div>
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100 mt-6">
                ...
                <button type="submit"
                    class="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium text-sm rounded-lg shadow-sm transition flex items-center gap-2">
